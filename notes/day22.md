# Day 22 Notes — AutoGen Foundations
...
This progression introduced increasingly sophisticated conversation-driven orchestration.
...
Day 22 demonstrated that modern conversation-based agent systems require:
...
```text
Conversation-based systems are powerful because agents can collaborate naturally.

However, they require stronger controls to prevent role drift and unpredictable behavior.
```
