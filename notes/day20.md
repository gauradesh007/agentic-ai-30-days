# Day 20 Notes — ChromaDB Vector Database
...
Day 20 demonstrated that modern retrieval systems require:
...
Vector databases make that meaning searchable.
```
