# Day 21 Notes — CrewAI Foundations
...
This demonstrated real-world LLM limitations.
...
## 5. LLMs Can Fail Validation Logic

Even when a validator recognizes a problem:
...
This is why production systems require robust validation layers.

---

# Final Understanding

Day 21 demonstrated that modern agent frameworks provide:
...
```text
Frameworks do not eliminate the need for validation.

Reliable AI systems still require workflow controls.
```
