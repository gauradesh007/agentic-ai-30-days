...
The goal was to move beyond simple memory storage and retrieval and begin building systems that can identify the most relevant memory for a given query.
